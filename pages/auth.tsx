    ...
    <div className='relative h-full w-full bg-[url("/images/hero.jpg")] bg-center bg-no-repeat bg-fixed bg-cover'> <div className='bg-black w-full h-full lg:bg-opacity-50'>
        <nav className='px-12 py-5'>
            ...
            <div className='flex justify-center'>
                <div className='bg-black bg-opacity-70 px-16 py-16 self-center lg:max-w-md rounded-md w-full'>
                    <h2 className='text-white mb-8 text-6xl font-semibold'>
                    ...
                    <div className='flex flex-row items-center gap-4 mt-8 justify-center'>
                        <div className='w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transiton'>
                            <FcGoogle onClick={()=>signIn('google',{callbackUrl:'/'})} size={30}/>
                        </div>                        <div onClick={()=>signIn('github',{callbackUrl:'/'})} className='w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transiton'>
                            <FaGithub size={30}/>
                        </div>
                    </div>
